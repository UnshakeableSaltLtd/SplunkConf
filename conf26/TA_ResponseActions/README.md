...
See [`process.md`](process.md) for the full step-by-step pipeline, from correlation search firing
...
See [`process.md`](process.md) for the detailed mechanics of every stage in this pipeline.
